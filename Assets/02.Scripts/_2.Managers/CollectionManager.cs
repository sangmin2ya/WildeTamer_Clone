...
namespace WildTamer
{
    /// <summary>
    /// 도감 항목 1개의 정의 데이터입니다.
    /// CollectionManager Inspector에서 5~6종을 등록합니다.
    /// </summary>
    [Serializable]
    ...
    public class CollectionManager : Singleton<CollectionManager>
    {
        ...
        private List<CollectionEntry> entries = new List<CollectionEntry>();
        ...
        /// </summary>
        public IReadOnlyList<CollectionEntry> GetAllEntries()
        {
            return entries;
        }
